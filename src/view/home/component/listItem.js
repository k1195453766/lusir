                ...
                <View style={styles.itemList}>
                    <View>
                        <ImageBackground
                            ...
                            style={{ width: width * 0.99, height: data.type == 1 ? 200 : 100, justifyContent: 'center', alignItems: 'center' }}
                            ...
                            data.type == 1 ? (
                                <View style={styles.video}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        <Image
                                            resizeMode={'contain'}
                                            source={require('../../../images/home/update.png')}
                                            style={{ width: 15, height: 15 }}
                                        />
                                        <Text style={styles.statement}>{'30分钟前更新'}</Text>
                                        <Image
                                            resizeMode={'contain'}
