 ...
 * @Last Modified time: 2019-01-28 12:00:10
 * @Describe 提现记录 */
...
export default class WithdrawalsRecord extends React.PureComponent {
    //构造方法
    constructor(props) {
        super(props);
        this.state = {
    ...
    _ListEmptyComponent = () => {
        return <View style={{ width: Dimension.width, height: 40, justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ fontSize: 16, color: 'gray' }}>暂时还没有提现记录</Text>
        </View>
    }
            ...
            <ScrollView>
                <View style={{ flex: 1, backgroundColor: color.white }}>
                    ...
                    <FlatList
                        ...
                        data={this.state.record} //数据源
                        extraData={this.state.record}
